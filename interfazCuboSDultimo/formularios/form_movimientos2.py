...
class Movimientos2: # Clase para mostrar los movimientos
    
    def __init__(self, panel_principal, controlador): # Constructor
        self.panel_principal = panel_principal
        self.controlador = controlador
        self.fondo = util_img.leer_imagen("./imagenes/mov2.png", (1270, 700))  
    ...
    def componentes(self): # Posicionar componentes
       ...
       # Botón Ant
       self.botonS = tk.Button(self.panel_principal, text="Anterior", bg="#292828", fg="#FFFFFF", font=("Roboto", 13), height=1)
       self.botonS.place(x=1000, y=650)
    ...
    def funcion_botonS(self, event): # evento - movimientos1
        self.controlador.mostrar_movimientos()
