...
class Movimientos: # Clase para explicar los movimientos
    
    def __init__(self, panel_principal, controlador): # Constructor
        self.panel_principal = panel_principal
        self.controlador = controlador
        self.fondo = util_img.leer_imagen("./imagenes/mov1.png", (1270, 700))
    ...
    def componentes(self):
       ...
       # Botón Sig
       self.botonS = tk.Button(self.panel_principal, text="Siguiente", bg="#292828", fg="#FFFFFF", font=("Roboto", 13), height=1)
       self.botonS.place(x=850, y=635)
    ...
    def funcion_botonS(self, event): # evento - movimientos2
        self.controlador.mostrar_movimientos2()
