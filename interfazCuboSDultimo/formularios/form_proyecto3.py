...
class Proyecto3: # Clase para explicar el posicionamiento de flechas
    
    def __init__(self, panel_principal, controlador): # Constructor
        self.panel_principal = panel_principal
        self.controlador = controlador
        self.fondo = util_img.leer_imagen("./imagenes/p3.png", (1300, 850))  
    ...
    def componentes(self): # Posicionar componentes
       ...
       # Botón Ant
       self.botonS = tk.Button(self.panel_principal, text="Anterior", bg="#F4F4F4", fg="#000000", font=("Roboto", 13), height=1)
       self.botonS.place(x=1000, y=600)
    ...
    def funcion_botonS(self, event): # evento - proyecto2
